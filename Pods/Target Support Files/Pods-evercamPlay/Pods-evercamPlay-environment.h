...
// Evercam
#define COCOAPODS_POD_AVAILABLE_Evercam
#define COCOAPODS_VERSION_MAJOR_Evercam 1
#define COCOAPODS_VERSION_MINOR_Evercam 0
#define COCOAPODS_VERSION_PATCH_Evercam 1
